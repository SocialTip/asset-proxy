 ...
 *
 * Playback begins automatically as soon as enough data has been buffered — `autoPlay` is not accepted as a prop since it is always implied.
 */
export function MediaSourceVideo({
  src,
  ref,
  ...videoProps
}: Omit<ComponentProps<"video">, "src" | "autoPlay"> & {
